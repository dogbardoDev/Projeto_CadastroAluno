		...
		bCadastrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						alunoDTO.setEmail(tEmail.getText());
						alunoDTO.setCEmail(tConfirmaEmail.getText());
						alunoDTO.setSenha(tSenha.getText());
						alunoDTO.setCSenha(tConfirmaSenha.getText());
						alunoDTO.setMatricula(fMatricula.getText());
